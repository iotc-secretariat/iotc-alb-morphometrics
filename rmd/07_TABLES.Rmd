...
```{r AICTable, tab.cap = "Estimates of degrees of freedom (df) and values of Akaike Information Criterion (AIC) for the five Generalized Additive Models fitted to the fork length and round weight data of Indian Ocean albacore"}
AIC_TABLE_FT 
```
